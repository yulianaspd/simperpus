        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="<?php echo base_url('kategori/create') ?>" class="btn btn-primary"><span class="fa fa-plus"></span> Input data</a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
 ...
 var table;
    $(document).ready(function() {
        ...
        table = $('#tabel-kategori').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo base_url('kategori/ajaxGetIndex')?>",
                "type": "POST"
            },
