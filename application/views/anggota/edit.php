            ...
            <form role="form" action="<?php echo base_url('anggota/update'); ?>" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="telepon" id="telepon" placeholder="telepon" value="<?php echo $anggota->telepon ?>">
                </div>

                <div class="form-group">
                    <label for="alamatLabel">Alamat</label>
                    <textarea class="form-control" cols="20" rows="3" name="alamat" id="alamat" placeholder="Alamat"><?php echo $anggota->alamat ?></textarea>
                </div>
