              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" name="nama_lengkap" id="nama_lengkap" placeholder="Nama Lengkap" value="<?php echo $this->session->flashdata('nama_lengkap') ?>">
                            </div>
                      <div class="col-md-4">
                        <label for="namaPanggilanLabel">Nama Panggilan</label>
                        <?php echo $this->session->flashdata('nama_panggilan') ?>
                        <input type="text" class="form-control" name="nama_panggilan" id="nama_panggilan" placeholder="Nama Panggilan" value="<?php echo $this->session->flashdata('nama_panggilan') ?>">
                      </div> 
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-8">
                          ...
                          <input type="number" class="form-control" name="noo_identitas" id="no_identitas" placeholder="No identitas" value="<?php echo $this->session->flashdata('no_identitas') ?>">
                      </div>  
                      <div class="col-md-4">
                          <label for="jenisIdentitasLabel">Jenis Identitas</label>
                          <?php echo $this->session->flashdata('jenis_identitas') ?>
                          <select class="form-control" name="jenis_identitas" id="jenis_identitas">
                              <?php foreach($jenis as $index => $value){ ?>
                ...
                <div class="form-group">
                    ...
                    <?php echo $this->session->flashdata('telepon') ?>
                     <input type="number" class="form-control" name="telepon" id="telepon" placeholder="telepon" value="<?php echo $this->session->flashdata('telepon') ?>">
                </div>

                <div class="form-group">
                    <label for="alamatLabel">Alamat</label>
                    <?php echo $this->session->flashdata('alamat') ?>
                    <textarea class="form-control" cols="20" rows="5" name="alamat" id="alamat" placeholder="Alamat"><?php echo $this->session->flashdata('telepon') ?></textarea>
                </div>
