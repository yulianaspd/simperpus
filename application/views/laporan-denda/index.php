          ...
          <div class="box box-primary" id="box-anggota">
            ...
            <form id="form-pinjam" role="form" action="#">
              <div class="box-body">  
                  ...
                  <table id="table-laporan-denda" class="table table-bordered table-striped" style="width:100%">
                     <thead>
                          <tr>
                            <th>No</th>
                            <th>Anggota</th>
                      ...
                      <tfoot>
                            <tr>
                              <th colspan="2"><h3>TOTAL DENDA</h3></th>
                              <th></th>
                            </tr>
                        </tfoot>
                  </table>
...
<script>
  ...
  $(document).ready(function(){
    ...
    //datatables
    table = $('#table-laporan-denda').DataTable({ 
        "processing": true, 
        "serverSide": true, 
        "order": [], 
